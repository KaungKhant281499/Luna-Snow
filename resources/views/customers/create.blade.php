        ...
        <div class="col-md-12 col-sm-12" style="box-shadow: 0 0 10px 3px rgba(100, 100, 100, 0.7); background-color: #ffffff; margin-top:60px; padding-bottom:15px; text-align:center; height:auto; width:100%">
            ...
            <div style="position: absolute; height: 50px; width: 280px;
                ...
                background-color:#2c74ae !important;">                
                    <font size="4" color="#ffffff"> Customer Account Set-Up  </font>
            </div>

            <form onsubmit="return cardSave();" style="margin-top:50px;" method="POST" action="{{ route('customers.store')}}" enctype="multipart/form-data" id="commentForm">
                @csrf    
                <div class="row">
                    <!-- Address -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-12 form-group"> 
                        <font size="5" face="Agency FB" color="#2c74ae">
                            <b> Address: </b>
                        </font>
                        <div>
                ...
                <div class="form-group row-md-12 row-sm-12">
                    <div class="col-md-6 offset-md-4">
                        <button onClick="cardSave()" type="submit" style="color:#ffffff; background-color:#2c74ae; font-weight: bold; margin-top:10px; margin-left:40px; padding: 7px 105px 7px 105px;">
                                {{ __('Finish Set-Up') }}
                        </button>
                    </div>
                </div>
